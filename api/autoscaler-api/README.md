# yingtest OpenAPI Specification
[![Build Status](https://travis-ci.org/cdlliuy/app-autoscaler.svg?branch=master)](https://travis-ci.org/cdlliuy/app-autoscaler)
...
6. If you did everything correct, https://cdlliuy.github.io/app-autoscaler/ will lead to your new docs
...
- Documentation(ReDoc): https://cdlliuy.github.io/app-autoscaler/
- Look full spec:
    + JSON https://cdlliuy.github.io/app-autoscaler/swagger.json
    + YAML https://cdlliuy.github.io/app-autoscaler/swagger.yaml
- Preview spec version for branch `[branch]`: https://cdlliuy.github.io/app-autoscaler/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://cdlliuy.github.io/app-autoscaler/ with url from the message: `Server started <url>`
